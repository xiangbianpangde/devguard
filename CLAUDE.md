...
> 更新: 2026-06-11（V2.2 #47 旧引用语义重映射交付；V2.3 #48-#50 进行中）
...
- **进度**：46/46 ✅（35 原始 + 11 V2.1 流程强制化）全部交付；**V2.2 #47 旧引用语义重映射 ✅**（conventions/templates 死链清零，详见 worklogs/2026-06-11_v2.2-fp47-remapping.md）；**V2.3 进行中**：#51 豁免登记 + #53/#54 更新时间标签（全仓 159 文档回填）+ #52 收束硬闸门 ✅（#48-#50 进行中，见 `docs/plan/design/设计提案-约束与模板强化方案-v2.3.md`）
