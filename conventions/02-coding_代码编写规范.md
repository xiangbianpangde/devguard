...
> **本规范是 [ai-workflow 04-长程开发](ai-workflow_AI协作开发流程/04-长程开发.md) 的细化**，把工作流里两个一句话带过的环节展开成可执行标准：
...
可操作的关键在于——规则不靠自觉，靠 pre-commit 和 CI 拦截。新项目在 [04-长程开发·基础设施 创建基础设施](ai-workflow_AI协作开发流程/04-长程开发.md) 时一并落地。
...
| 方向 | 链接 |
|------|------|
| 细化自 | [ai-workflow 04-长程开发·实现/审查](ai-workflow_AI协作开发流程/04-长程开发.md) |
