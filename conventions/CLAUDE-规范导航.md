...
|---------|--------|--------------------------|
| 长程·架构设计 | [01 架构](01-architecture_架构设计规范.md) | 分层 / 依赖方向 / 模块划分 / 配置 |
| 04-长程开发·实现 | [02 代码](02-coding_代码编写规范.md) + [04 API](04-api_API设计规范.md)(若写接口) | 命名/结构/错误处理/安全 + REST 设计 |
| 04-长程开发·TDD/可观测验证 | [05 测试](05-testing_测试规范.md) | TDD 节奏 / 覆盖率 / Mock 边界 |
| 04-长程开发·审查 diff | [02 §六检查清单](02-coding_代码编写规范.md) | 审查清单 = 该篇检查清单 |
| 04-长程开发·Git 提交 | [03 Git](03-git_Git协作规范.md) | 分支 / 提交格式 / PR / 合并 |
| 汇报收束·记录 + 07-汇报 | [06 文档](06-documentation_文档规范.md) | README/CHANGELOG/docstring/worklog |
| 04-长程开发·工具增强 | [08 图谱](08-code-understanding_代码理解与图谱规范.md) | 双图谱：CodeGraph（AI 用）+ Understand-Anything（人用） |

> 档位裁剪：轻量项目只守红线；标准/团队守全部。档位定义见 [04-长程开发·档位](ai-workflow_AI协作开发流程/04-长程开发.md)。
