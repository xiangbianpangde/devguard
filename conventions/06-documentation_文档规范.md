...
> - 细化 [04-长程开发 §四 更新记录环节](ai-workflow_AI协作开发流程/04-长程开发.md)（worklog / STATUS / CLAUDE）与 [08-汇报收束](ai-workflow_AI协作开发流程/08-汇报收束.md)。
> - 细化交付物文档（README / CHANGELOG / 设计文档）；并支撑[收束节点](ai-workflow_AI协作开发流程/08-汇报收束.md)整理阶段的「文档同步检查」。
>
...
| 规则 | 要点 |
|------|------|
| 收束节点检查文档一致性 | 逐份对照代码现状（[08-汇报收束 §六 整理阶段](ai-workflow_AI协作开发流程/08-汇报收束.md)） |
...
| 方向 | 链接 |
|------|------|
| 细化自 | [04-长程开发 §四 更新记录](ai-workflow_AI协作开发流程/04-长程开发.md) · [08-汇报收束](ai-workflow_AI协作开发流程/08-汇报收束.md) |
...
| 文档一致性检查时机 | [08-汇报收束 §六 收束节点](ai-workflow_AI协作开发流程/08-汇报收束.md) |
