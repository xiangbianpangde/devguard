...
> **本规范是 [ai-workflow 03-设计规范](ai-workflow_AI协作开发流程/03-设计规范.md)（设计阶段）的细化**，把「技术选型 / 架构设计」环节展开成可执行标准，并作为 [04-长程开发 §四 审查 diff](ai-workflow_AI协作开发流程/04-长程开发.md)「架构层面」的判据。
>
...
| 方向 | 链接 |
|------|------|
| 细化自 | [ai-workflow 03-设计规范](ai-workflow_AI协作开发流程/03-设计规范.md) |
...
| ADR 产出时机 | [ai-workflow 08-汇报收束](ai-workflow_AI协作开发流程/08-汇报收束.md) |
