...
> **本规范是 [ai-workflow 04-长程开发](ai-workflow_AI协作开发流程/04-长程开发.md)（迭代开发工具链）的细化**，定义「代码理解需要什么图谱、谁来用、怎么建」。
...
| 方向 | 链接 |
|------|------|
| 细化自 | [ai-workflow 04-长程开发（迭代开发工具链）](ai-workflow_AI协作开发流程/04-长程开发.md) |
...
| 收束节点审计 | [ai-workflow 08-汇报收束 §6.4 审计](ai-workflow_AI协作开发流程/08-汇报收束.md) |
