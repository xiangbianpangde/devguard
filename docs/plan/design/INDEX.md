...
| 模块内新增设计提案 | 登记到 [README-设计文档说明.md](README-设计文档说明.md)「当前跨模块提案 / 红蓝对抗整理周期提案」区（2026-08-13 红队 R-07 补规约） |
...
- [设计提案-S1-临时目录构建与原子rename.md](设计提案-S1-临时目录构建与原子rename.md) — S-1 staging 原子提交（2026-08-14，红队建议，已实现 993f450）
