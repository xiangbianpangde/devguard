...
| 问题 | devguard 的答案 |
|------|----------------|
| 新项目启动无统一基准，风格靠人记 | 7 篇核心规范 + 9 篇 AI 协作流程 + 9 项根文件存在性 L1；※载荷现状：scaffold 初始化后 conventions/ 仅含 README（规范正文入库载荷待 Owner 决策，R5-28b） |
...
flowchart TB
    ...
    subgraph L2["规范层（说什么）"]
        C1["7 篇核心规范正文<br/>01-06,08 + 09-17 存在性 L1"]
...
```
devguard/
├── conventions/            # 规范正文：7 篇核心（01-06,08）+ ai-workflow 流程 9 篇 + 双导航
├── docs/
